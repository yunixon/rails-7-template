...
valid_class: 'form-group-valid' do |b|
  ...
  config.wrappers :vertical_boolean, tag: 'fieldset', class: 'form-group my-3', error_class: 'form-group-invalid',
valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.optional :readonly
  ...
  config.wrappers :vertical_collection, item_wrapper_class: 'form-check my-3', item_label_class: 'form-check-label',
tag: 'fieldset', class: 'form-group', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
  ...
  config.wrappers :vertical_collection_inline, item_wrapper_class: 'form-check form-check-inline my-3',
item_label_class: 'form-check-label', tag: 'fieldset', class: 'form-group', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
  ...
  # vertical file input
  config.wrappers :vertical_file, tag: 'div', class: 'form-group my-3', error_class: 'form-group-invalid',
valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
  ...
  config.wrappers :vertical_multi_select, tag: 'div', class: 'form-group my-3', error_class: 'form-group-invalid',
valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.optional :readonly
    b.use :label
  ...
  config.wrappers :vertical_range, tag: 'div', class: 'form-group my-3', error_class: 'form-group-invalid',
valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :readonly
